...
require (
	github.com/apple/foundationdb/bindings/go v0.0.0-20220428144857-0ae0bf9e3196
...
replace github.com/libp2p/go-libp2p-core v0.10.0 => github.com/libp2p/go-libp2p-core v0.14.0
